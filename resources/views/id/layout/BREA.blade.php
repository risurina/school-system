...
@foreach( $dataList as $data )
	<div class="id-page">
		...
		<span class="id-number-first">
			...
			@else
				{{ $data[0]->school_year_level_section->employee->full_name }}
		...
		<span class="id-number-second">
			...
			@else
				{{ $data[1]->school_year_level_section->employee->full_name }}
